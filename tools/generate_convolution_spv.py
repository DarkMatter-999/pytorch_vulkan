...
binary = pathlib.Path("/tmp/convolution.comp.spv")
header_path = root / "src/vulkan/shaders/generated/convolution_spv.h"
manifest_path = root / "src/vulkan/shaders/generated/convolution_spv.sha256"
...
with header_path.open("w", encoding="ascii") as header:
    header.write("#pragma once\n#include <cstddef>\n#include <cstdint>\nnamespace vulkan_convolution_shader {\ninline constexpr uint32_t kCode[] = {\n")
