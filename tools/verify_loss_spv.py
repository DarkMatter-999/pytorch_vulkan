...
for token in ("binding = 0", "binding = 1", "binding = 2", "binding = 3",
              "mse_loss", "params.element_count", "params.reduction", "params.backward"):
...
actual = {"source_sha256": hashlib.sha256(SOURCE.read_bytes()).hexdigest(),
