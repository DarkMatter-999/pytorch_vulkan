...
at::Tensor prod_tensor(const at::Tensor &, c10::OptionalArrayRef<int64_t>, bool,
                       c10::optional<at::ScalarType>);
at::Tensor prod_dim_tensor(const at::Tensor &, int64_t, bool,
                           c10::optional<at::ScalarType>);
at::Tensor &prod_int_out(const at::Tensor &, int64_t, bool,
                         c10::optional<at::ScalarType>, at::Tensor &);
...
at::Tensor autograd_prod_dim(const at::Tensor &, int64_t, bool,
                             c10::optional<at::ScalarType>);
