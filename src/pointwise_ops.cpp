...
class act_cls : public torch::autograd::Function<act_cls<Act>> {
  public:
    ...
    static tensor_list std_activation_backward(AutogradContext *ctx,
...
Tensor &mul_scalar_(Tensor &self, const Scalar &other) {
    ...
    dlprim::core::pointwise_operation({x0}, {x0}, {scale}, "y0 = x0*w0;",
...
// {"schema": "aten::add.out(Tensor self, Tensor other, *, Scalar alpha=1, Tensor(a!)
// out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &add_out(const Tensor &self, const Tensor &other, const Scalar &alpha,
    ...
    if (isCPUScalar(other, value)) {
        ...
        dlprim::core::pointwise_operation({x0}, {y0}, {w0}, "y0 = x0 + w0;",
                                          getExecutionContext(self));
        ...
        dlprim::core::pointwise_operation({x0}, {y0}, {w0, w1}, "y0 = w0 + x0 * w1;",
...
// {"schema": "aten::exp.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", "dispatch":
// "True", "default": "False"}
...
// {"schema": "aten::log.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", "dispatch":
// "True", "default": "False"}
...
// {"schema": "aten::sub.out(Tensor self, Tensor other, *, Scalar alpha=1, Tensor(a!)
// out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &sub_out(const Tensor &self, const Tensor &other, const Scalar &alpha,
                Tensor &out) {
    GUARD;
    return add_out(self, other, Scalar(alpha.toDouble() * -1), out);
}

// {"schema": "aten::addcmul.out(Tensor self, Tensor tensor1, Tensor tensor2, *, Scalar
// value=1, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &addcmul_out(const Tensor &self, const Tensor &tensor1, const Tensor &tensor2,
                    const Scalar &value, Tensor &out) {
    GUARD;
    Tensor self_c = self.contiguous(), out_c = out.contiguous(),
...
Tensor &comp_out(const Tensor &self, const Scalar &other, Tensor &out,
                 std::string const &op) {
    GUARD;
    Tensor self_c = self.contiguous(), out_c = out.contiguous();
...
// {"schema": "aten::le.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) ->
...
// {"schema": "aten::ge.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &ge_out(const Tensor &self, const Scalar &other, Tensor &out) {
    return comp_out(self, other, out, ">=");
}

// {"schema": "aten::lt.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &lt_out(const Tensor &self, const Scalar &other, Tensor &out) {
    return comp_out(self, other, out, "<");
}
// {"schema": "aten::gt.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &gt_out(const Tensor &self, const Scalar &other, Tensor &out) {
    return comp_out(self, other, out, ">");
}

// {"schema": "aten::neg.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", "dispatch":
// "True", "default": "False"}
...
// {"schema": "aten::pow.Tensor_Scalar_out(Tensor self, Scalar exponent, *, Tensor(a!)
// out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::div.out(Tensor self, Tensor other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &div_out(const Tensor &self, const Tensor &other, Tensor &out) {
    ...
    if (isCPUScalar(other, value)) {
        dlprim::core::pointwise_operation({x0}, {y0}, {double(1.0 / value)},
                                          "y0 = x0*w0;", getExecutionContext(self));
    } else {
        Tensor other_c = other.contiguous();
        dlprim::Tensor x1 = todp(other_c);
        dlprim::core::pointwise_operation_broadcast({x0, x1}, {y0}, {}, "y0 = x0/x1;",
                                                    getExecutionContext(self));
    }
...
// {"schema": "aten::lerp.Scalar_out(Tensor self, Tensor end, Scalar weight, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &lerp_out(const Tensor &self, const Tensor &end, const Scalar &weight,
                 Tensor &out) {
    GUARD;
    Tensor self_c = self.contiguous();
...
Tensor &binary_op_out_tensor(const Tensor &self, const Tensor &other, Tensor &out,
                             std::string const &op, std::string op_builder = "") {
    GUARD;
    Tensor self_c = self.contiguous(), out_c = out.contiguous(),
...
// {"schema": "aten::addcdiv.out(Tensor self, Tensor tensor1, Tensor tensor2, *, Scalar
// value=1, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &addcdiv_out(const Tensor &self, const Tensor &tensor1, const Tensor &tensor2,
                    const Scalar &value, Tensor &out) {
    GUARD;
    Tensor self_c = self.contiguous(), out_c = out.contiguous(),
           tensor1_c = tensor1.contiguous(), tensor2_c = tensor2.contiguous();
...
// {"schema": "aten::threshold_backward.grad_input(Tensor grad_output, Tensor self,
// Scalar threshold, *, Tensor(a!) grad_input) -> Tensor(a!)", "dispatch": "True",
// "default": "False"}
Tensor &threshold_backward_out(const Tensor &grad_output, const Tensor &self,
                               const Scalar &threshold, Tensor &grad_input) {
    GUARD;
    Tensor self_c = self.contiguous(), grad_input_c = grad_input.contiguous(),
...
squeeze_dim(dlprim::Shape s, OptionalIntArrayRef odim, bool keepdim) {
    GUARD;
...
enum class RedOp { sum, mean, prod };

Tensor &red_op_out(const Tensor &self, OptionalIntArrayRef dim, bool keepdim,
                   c10::optional<ScalarType> /*dtype*/, Tensor &out, RedOp rop) {
    GUARD;
    Tensor self_c = self.contiguous(), out_c = out.contiguous();
    ...
    double scale = (rop == RedOp::mean)
                       ? double(Y.shape().total_size()) / double(X.shape().total_size())
                       : 1;

    auto q = getExecutionContext(self);
    dlprim::Context ctx(q);
    auto op = dlprim::core::PointwiseOperationBroadcastReduce::create(
        ctx, {X.specs()}, {Y.specs()}, 0, dlprim::float_data, "y0=x0;",
...
// {"schema": "aten::mean.out(Tensor self, int[1]? dim, bool keepdim=False, *,
// ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True",
// "default": "False"}
Tensor &mean_out(const Tensor &self, OptionalIntArrayRef dim, bool keepdim,
                 c10::optional<ScalarType> dtype, Tensor &out) {
    GUARD;
    return red_op_out(self, dim, keepdim, dtype, out, RedOp::mean);
}

// {"schema": "aten::sum.IntList_out(Tensor self, int[1]? dim, bool keepdim=False, *,
// ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True",
// "default": "False"}
Tensor &sum_out(const Tensor &self, OptionalIntArrayRef dim, bool keepdim,
                c10::optional<ScalarType> dtype, Tensor &out) {
    GUARD;
    return red_op_out(self, dim, keepdim, dtype, out, RedOp::sum);
}
// {"schema": "aten::prod.int_out(Tensor self, int dim, bool keepdim=False, *,
// ScalarType? dtype=None, Tensor(a!) out) -> Tensor(a!)", "dispatch": "True",
// "default": "False"}
Tensor &prod_out(const Tensor &self, int64_t dim, bool keepdim,
                 ::std::optional<ScalarType> dtype, Tensor &out) {
    GUARD;
    std::vector<int64_t> dims({dim});
    return red_op_out(self, dims, keepdim, dtype, out, RedOp::prod);
}

// {"schema": "aten::hardtanh_(Tensor(a!) self, Scalar min_val=-1, Scalar max_val=1) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::hardtanh_backward(Tensor grad_output, Tensor self, Scalar min_val,
// Scalar max_val) -> Tensor", "dispatch": "True", "default": "False"}
Tensor hardtanh_backward(const Tensor &grad_output, const Tensor &self,
    ...
    double w0 = min_val.toDouble();
    double w1 = max_val.toDouble();
    dlprim::core::pointwise_operation({X, dY}, {dX}, {w0, w1},
                                      "y0 = (w0 <= x0 && x0 <= w1) ? x1 : 0;",
                                      getExecutionContext(self));
    sync_if_needed(self.device());
    return result;
...
// {"schema": "aten::abs.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", "dispatch":
// "True", "default": "False"}
...
// {"schema": "aten::sgn.out(Tensor self, *, Tensor(a!) out) -> Tensor(a!)", "dispatch":
// "True", "default": "False"}
...
// {"schema": "aten::cat.out(Tensor[] tensors, int dim=0, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::_cat(Tensor[] tensors, int dim=0) -> Tensor", "dispatch": "True",
// "default": "False"}
...
Tensor &hardswish_(Tensor &self) {
    ...
    dlprim::core::pointwise_operation(
        {x}, {x}, {}, "y0 = x0 <= -3.0f ? 0 : (x0>=3.0f ? x0 : x0*(x0+3.0f)/6.0f);",
        getExecutionContext(self));
...
Tensor &hardsigmoid_out(const Tensor &self, Tensor &out) {
    GUARD;
    return unitary_op(self, out,
                      "y0 = x0 <= -3.0f ? 0 : (x0>=3.0f ? 1.0f : x0/6.0f + 0.5f);");
}
// {"schema": "aten::hardsigmoid_backward.grad_input(Tensor grad_output, Tensor self, *,
...
// {"schema": "aten::sigmoid(Tensor self) -> Tensor", "dispatch": "True", "default":
// "True"}
...
// {"schema": "aten::sigmoid_(Tensor(a!) self) -> Tensor(a!)", "dispatch": "True",
// "default": "True"}
...
// {"schema": "aten::sigmoid_backward.grad_input(Tensor grad_output, Tensor output, *,
// Tensor(a!) grad_input) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &sigmoid_backward_out(const Tensor &grad_output, const Tensor &output,
    ...
    dlprim::Tensor dx = todp(grad_input_c);
    dlprim::core::activation_backward(dx, dy, y, dlprim::StandardActivations::sigmoid,
                                      0, getExecutionContext(grad_output));
...
// {"schema": "aten::tanh_backward.grad_input(Tensor grad_output, Tensor output, *,
// Tensor(a!) grad_input) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &tanh_backward_out(const Tensor &grad_output, const Tensor &output,
                          Tensor &grad_input) {
    GUARD;
    Tensor grad_input_c = grad_input.contiguous(),
           grad_output_c = grad_output.contiguous(), output_c = output.contiguous();
...
// {"schema": "aten::silu_backward.grad_input(Tensor grad_output, Tensor self, *,
// Tensor(a!) grad_input) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &silu_backward_out(const Tensor &grad_output, const Tensor &self,
                          Tensor &grad_input) {
    GUARD;
    Tensor grad_output_c = grad_output.contiguous(),
           grad_input_c = grad_input.contiguous(), self_c = self.contiguous();
...
// {"schema": "aten::tanh(Tensor self) -> Tensor", "dispatch": "True", "default":
// "True"}
...
// {"schema": "aten::tanh_(Tensor(a!) self) -> Tensor(a!)", "dispatch": "True",
// "default": "True"}
...
// {"schema": "aten::leaky_relu.out(Tensor self, Scalar negative_slope=0.01, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::leaky_relu_backward.grad_input(Tensor grad_output, Tensor self,
// Scalar negative_slope, bool self_is_result, *, Tensor(a!) grad_input) -> Tensor(a!)",
// "dispatch": "True", "default": "False"}
Tensor &leaky_relu_backward_out(const Tensor &grad_output, const Tensor &self,
                                const Scalar &negative_slope, bool /*self_is_result*/,
                                Tensor &grad_input) {
    GUARD;
    double slope = negative_slope.to<double>();
    Tensor self_c = self.contiguous(), grad_input_c = grad_input.contiguous(),
    ...
    dlprim::Tensor dy = todp(grad_output_c);
    dlprim::Tensor dx = todp(grad_input_c);
    dlprim::core::pointwise_operation({y, dy}, {dx}, {slope},
                                      "y0 = x0 > 0 ? x1 : w0 * x1;",
                                      getExecutionContext(self));
...
// {"schema": "aten::amax.out(Tensor self, int[1] dim=[], bool keepdim=False, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &amin_amax_out(const Tensor &self, IntArrayRef dim, bool keepdim, Tensor &out,
                      bool is_max) {
    GUARD;
    Tensor self_c = self.contiguous();
    Tensor out_c = out.contiguous();
    ...
    dlprim::ExecutionContext q = getExecutionContext(self);
    dlprim::Context ctx(q);
    std::string ext_val = dlprim::data_type_to_opencl_numeric_limit(
        X.dtype(), (is_max ? dlprim::dt_min_val : dlprim::dt_max_val));
    auto op = dlprim::core::PointwiseOperationBroadcastReduce::create(
        ctx, {X.specs()}, {Yval.specs()}, 0, X.dtype(), "y0=x0;",
        "reduce_y0 = " + ext_val + ";",
...
// {"schema": "aten::amin.out(Tensor self, int[1] dim=[], bool keepdim=False, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &amin_out(const Tensor &self, IntArrayRef dim, bool keepdim, Tensor &out) {
    return amin_amax_out(self, dim, keepdim, out, false);
}

// {"schema": "aten::argmax.out(Tensor self, int? dim=None, bool keepdim=False, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &argmax_out(const Tensor &self, c10::optional<int64_t> dim, bool keepdim,
                   Tensor &out) {
    GUARD;
    Tensor self_c = self.contiguous(), out_c = out.contiguous();
    ...
    dlprim::Context ctx(q);
    std::string min_val =
        dlprim::data_type_to_opencl_numeric_limit(X.dtype(), dlprim::dt_min_val);
    auto op = dlprim::core::PointwiseOperationBroadcastReduce::create(
        ctx, {X.specs()}, {Yval.specs(), Yind.specs()}, 0, dlprim::float_data,
        "y0=x0; y1=reduce_item;", "reduce_y0 = " + min_val + "; reduce_y1 = -1;",
        R"xxx(
                        if(y0 > reduce_y0) {
                            reduce_y0 = y0; 
                            reduce_y1 = y1; 
...
static Tensor min_or_max(const Tensor &self, bool is_min) {
    ...
    dlprim::Tensor Y = todp(result);
    std::string y0 = dlprim::data_type_to_opencl_numeric_limit(
        X.dtype(), (is_min ? dlprim::dt_max_val : dlprim::dt_min_val));
    dlprim::ExecutionContext q = getExecutionContext(self);
    dlprim::Context ctx(q);
    auto op = dlprim::core::PointwiseOperationBroadcastReduce::create(
        ctx, {X.specs()}, {Y.specs()}, 0, X.dtype(), "y0=x0;",
        std::string("reduce_y0 = ") + y0 + ";",
        std::string("reduce_y0 = y0 ") + (is_min ? "<" : ">") +
            " reduce_y0 ? y0 : reduce_y0;");
    WSGuard ws_guard(op->workspace(), self.device());
...
// {"schema": "aten::min(Tensor self) -> Tensor", "dispatch": "True", "default":
// "False"}
Tensor min(const Tensor &self) { return min_or_max(self, true); }

// {"schema": "aten::max(Tensor self) -> Tensor", "dispatch": "True", "default":
// "False"}
Tensor max(const Tensor &self) { return min_or_max(self, false); }

// {"schema": "aten::dot(Tensor self, Tensor tensor) -> Tensor", "dispatch": "True",
// "default": "False"}
Tensor dot(const Tensor &self, const Tensor &tensor) {
    ...
    dlprim::Context ctx(q);
    auto op = dlprim::core::PointwiseOperationBroadcastReduce::create(
        ctx, {x0.specs(), x1.specs()}, {y.specs()}, 0, dlprim::float_data, "y0=x0*x1;",
        "reduce_y0 = 0;", "reduce_y0 += y0;");
...
// {"schema": "aten::ne.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &ne_out(const Tensor &self, const Scalar &other, Tensor &out) {
    ...
    dlprim::Tensor x(todp(self_c));
    dlprim::Tensor y(todp(out_c));
    dlprim::core::pointwise_operation_broadcast({x}, {y}, {other.to<double>()},
                                                {x.dtype()}, "y0 = x0 != w0;",
                                                getExecutionContext(self));
...
// {"schema": "aten::eq.Scalar_out(Tensor self, Scalar other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::bitwise_and.Tensor_out(Tensor self, Tensor other, *, Tensor(a!)
// out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &bitwise_and_out(const Tensor &self, const Tensor &other, Tensor &out) {
    GUARD;
    TORCH_CHECK(is_integer(self, true) && is_integer(other, true),
                "& is not valid for floating point");
    return binary_op_out_tensor(self, other, out,
                                (self.dtype() == c10::kBool ? "&&" : "&"));
}
// {"schema": "aten::bitwise_or.Tensor_out(Tensor self, Tensor other, *, Tensor(a!) out)
// -> Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::bitwise_xor.Tensor_out(Tensor self, Tensor other, *, Tensor(a!)
// out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::clamp.out(Tensor self, Scalar? min=None, Scalar? max=None, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &clamp_out(const Tensor &self, const c10::optional<Scalar> &min,
    ...
    if (min && max)
        dlprim::core::pointwise_operation({X}, {Y},
                                          {min->to<double>(), max->to<double>()},
                                          "y0 = max(w0,min(w1,x0));", q);
    else if (min)
        dlprim::core::pointwise_operation({X}, {Y}, {min->to<double>()},
                                          "y0 = max(w0,x0);", q);
    else if (max)
        dlprim::core::pointwise_operation({X}, {Y}, {max->to<double>()},
                                          "y0 = min(w0,x0);", q);
    else
...
// {"schema": "aten::clamp.out(Tensor self, Scalar min, Tensor(a!) out) -> Tensor(a!)",
// "dispatch": "True", "default": "False"}
...
// {"schema": "aten::gelu.out(Tensor self, *, str approximate='none', Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
Tensor &gelu_out(const Tensor &self, c10::string_view approximate, Tensor &out) {
    ...
    if (approximate == "tanh")
        ...
        dlprim::core::pointwise_operation(
            {X}, {Y}, {}, "y0 = x0 * (1.0f + erf(x0 * 0.7071067811865475f  )) / 2.0f;",
...
// {"schema": "aten::gelu_backward.grad_input(Tensor grad_output, Tensor self, *, str
// approximate='none', Tensor(a!) grad_input) -> Tensor(a!)", "dispatch": "True",
// "default": "False"}
...
// {"schema": "aten::logit.out(Tensor self, float? eps=None, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::logit(Tensor self, float? eps=None) -> Tensor", "dispatch": "True",
// "default": "False"}
...
// {"schema": "aten::arange.start_out(Scalar start, Scalar end, Scalar step=1, *,
// Tensor(a!) out) -> Tensor(a!)", "dispatch": "True", "default": "False")
Tensor &arange_out(const Scalar &start, const Scalar &end, const Scalar &step,
                   Tensor &out) {
    GUARD;
...
// {"schema": "aten::minimum.out(Tensor self, Tensor other, *, Tensor(a!) out) ->
// Tensor(a!)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::log_sigmoid_forward.output(Tensor self, *, Tensor(a!) output,
// Tensor(b!) buffer) -> (Tensor(a!), Tensor(b!))", "dispatch": "True", "default":
// "False"
::std::tuple<Tensor &, Tensor &>
log_sigmoid_forward_out(const Tensor &self, Tensor &output, Tensor &buffer) {
    GUARD;
    Tensor self_c = self.contiguous(), output_c = output.contiguous(),
           buffer_c = buffer.contiguous();
...
/// {"schema": "aten::log_sigmoid_forward(Tensor self) -> (Tensor output, Tensor
/// buffer)", "dispatch": "True", "default": "False"}
...
// {"schema": "aten::log_sigmoid_backward.grad_input(Tensor grad_output, Tensor self,
// Tensor buffer, *, Tensor(a!) grad_input) -> Tensor(a!)", "dispatch": "True",
// "default": "False"}
...
// {"schema": "aten::log_sigmoid_backward(Tensor grad_output, Tensor self, Tensor
// buffer) -> Tensor", "dispatch": "True", "default": "False"}
...
TORCH_LIBRARY_IMPL(aten, PrivateUse1, m) {
    ...
    m.impl("aten::hardsigmoid_backward.grad_input",
           &ptdlprim::hardsigmoid_backward_out);
    ...
    m.impl("aten::log_sigmoid_backward.grad_input",
           &ptdlprim::log_sigmoid_backward_out);
